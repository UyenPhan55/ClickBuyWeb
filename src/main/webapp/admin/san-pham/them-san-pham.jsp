...
<c:set var="breadcrumb" value="Sản phẩm / Thêm mới"/>
        ...
        <div class="page-content">
            ...
            <div class="card" style="max-width:780px;margin:auto">
                <div class="card-header d-flex align-items-center gap-2">
                    ...
                    <div class="card-title mb-0"><i class="bi bi-plus-circle-fill"></i> Thêm sản phẩm mới</div>
                </div>
                <div class="card-body" style="padding:24px">
                    <%-- Khi ghép Servlet: đổi action="ProductServlet?action=insert" --%>
                    <form action="danh-sach-san-pham.jsp" method="post">
                        ...
                        <div class="row align-items-start">
                            ...
                            <div class="col-md-4 mb-3 text-center">
                                ...
                                <img id="imgPreview" src="https://placehold.co/120x120?text=Ảnh"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="trang_thai" class="form-select" required>
                                <option value="dang_ban" selected>Đang bán</option>
