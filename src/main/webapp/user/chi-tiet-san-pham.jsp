...
                    <div class="d-flex align-items-center mb-3">
                        <img src="${pageContext.request.contextPath}${detail.urlAnh.contains('/') ? (detail.urlAnh.startsWith('/') ? '' : '/') : '/assets/images/'}${detail.urlAnh}" style="width: 60px; height: 60px; object-fit: contain;" class="me-3">
                        <div>
...
        // SỬA CHỖ NÀY: Gửi cả 2 cách đặt tên (idBienThe/id_bien_the) để dù Servlet gọi kiểu gì cũng nhận được
